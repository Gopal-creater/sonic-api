...
const add_files_dto_1 = require("../dto/add-files.dto");
...
let JobFileController = class JobFileController {
    ...
    async addFilesToJob(jobId, addFilesDto) {
        return this.jobFileService.addFilesToJob(jobId, addFilesDto);
    }
    deleteJobFile(jobId, fileId) {
        return this.jobFileService.deleteFileFromJob(jobId, fileId);
    }
};
__decorate([
...
__decorate([
    swagger_1.ApiOperation({ summary: 'Add files to job' }),
    swagger_1.ApiBearerAuth(),
    common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, add_files_dto_1.AddFilesDto]),
...
__decorate([
    ...
    swagger_1.ApiBearerAuth(),
    common_1.UseGuards(jwt_auth_guard_1.JwtAuthGuard),
    common_1.Delete('/deletefile/:fileId'),
...
JobFileController = __decorate([
    ...
    __metadata("design:paramtypes", [job_file_service_1.JobFileService, job_service_1.JobService])
], JobFileController);
