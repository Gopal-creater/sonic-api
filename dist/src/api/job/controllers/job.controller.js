...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get All Jobs of particular owner' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, anyapiquerytemplate_decorator_1.AnyApiQueryTemplate)(),
    (0, common_1.Get)('/owners/:ownerId'),
    openapi.ApiResponse({ status: 200, type: require("../dto/mongoosepaginate-job.dto").MongoosePaginateJobDto }),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, job_license_validation_guard_1.JobLicenseValidationGuard),
    (0, swagger_1.ApiBearerAuth)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Make this job completed' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id/make-completed'),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get count of all job also accept filter as query params' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get One Job By Id' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update one Job' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Put)(':id'),
    openapi.ApiResponse({ status: 200, type: Object }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Delete one Job' }),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
...
JobController = __decorate([
    (0, swagger_1.ApiTags)('Jobs Controller'),
