...
class AddKeyAndUpdateJobFileDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { sonicKey: { required: true, type: () => require("../../sonickey/dtos/create-sonickey.dto").CreateSonicKeyFromJobDto } };
    }
}
__decorate([
    swagger_1.ApiProperty(),
...
], AddKeyAndUpdateJobFileDto.prototype, "sonicKey", void 0);
