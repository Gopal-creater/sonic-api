...
], DetectionOwnerController.prototype, "createFromBinary", null);
__decorate([
    swagger_1.ApiSecurity('x-api-key'),
    ...
    __metadata("design:returntype", Promise)
], DetectionOwnerController.prototype, "createFromHardware", null);
__decorate([
    common_1.Get('/count'),
...
//# sourceMappingURL=detection.user.controller.js.map