...
exports.AddUserToLicenseSecurityGuard = void 0;
const common_1 = require("@nestjs/common");
const Enums_1 = require("../../../constants/Enums");
const licensekey_service_1 = require("../services/licensekey.service");
let AddUserToLicenseSecurityGuard = class AddUserToLicenseSecurityGuard {
    ...
    async canActivate(context) {
        ...
        const addUserToLicense = request === null || request === void 0 ? void 0 : request.body;
        switch (loggedInUser.userRole) {
            ...
            default:
                ...
                if (addUserToLicense.user !== ownerId) {
                    throw new common_1.UnprocessableEntityException('Resource mismatch, Please provide your own user id');
                }
                const licenseKeyfromdb = await this.licensekeyService.findById(licenseKeyId);
                if (licenseKeyfromdb.type !== Enums_1.ApiKeyType.INDIVIDUAL) {
                    throw new common_1.UnprocessableEntityException('Only Individual license is allowed to add');
                }
                if (licenseKeyfromdb.type == Enums_1.ApiKeyType.INDIVIDUAL &&
                    ((_d = licenseKeyfromdb.users) === null || _d === void 0 ? void 0 : _d.length) > 0) {
                    throw new common_1.UnprocessableEntityException('Given license is already used by someone');
                }
        }
        return true;
    }
...
//# sourceMappingURL=adduserto-license-security.guard%20copy.js.map