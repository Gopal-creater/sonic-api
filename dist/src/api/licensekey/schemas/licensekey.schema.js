...
__decorate([
    ...
    (0, mongoose_1.Prop)({ type: String, ref: 'User', required: true, autopopulate: true }),
...
LicenseKey = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: exports.LicenseKeySchemaName })
], LicenseKey);
