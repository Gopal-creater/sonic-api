...
class CreateThirdpartyDetectionDto {
    constructor() {
        this.detectionTime = new Date();
    }
    static _OPENAPI_METADATA_FACTORY() {
        return { sonicKey: { required: true, type: () => String }, detectionTime: { required: false, type: () => Date, default: new Date() }, metaData: { required: false } };
    }
}
__decorate([
