...
const chargebee_payment_service_1 = require("./chargebee-payment.service");
...
], ChargebeePaymentController.prototype, "createPayment", null);
ChargebeePaymentController = __decorate([
    (0, swagger_1.ApiTags)('Chargebee payment controller'),
    (0, common_1.Controller)('chargebee-payment'),
