...
class CreateRadiostationSonicKeyDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { radioStation: { required: true, type: () => String }, sonicKey: { required: true, type: () => String }, owner: { required: true, type: () => String } };
    }
}
__decorate([
...
__decorate([
    swagger_1.ApiProperty(),
    __metadata("design:type", String)
], CreateRadiostationSonicKeyDto.prototype, "owner", void 0);
