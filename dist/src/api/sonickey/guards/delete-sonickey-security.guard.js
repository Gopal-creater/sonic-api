...
exports.DeleteSonicKeySecurityGuard = void 0;
const common_1 = require("@nestjs/common");
const Enums_1 = require("../../../constants/Enums");
const sonickey_service_1 = require("../services/sonickey.service");
let DeleteSonicKeySecurityGuard = class DeleteSonicKeySecurityGuard {
    ...
    async canActivate(context) {
        ...
        const sonickey = (_a = request === null || request === void 0 ? void 0 : request.params) === null || _a === void 0 ? void 0 : _a.sonickey;
...
//# sourceMappingURL=delete-sonickey-security.guard.js.map