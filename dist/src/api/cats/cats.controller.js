...
const create_radiostation_dto_1 = require("../radiostation/dto/create-radiostation.dto");
let CatsController = class CatsController {
    ...
    createRS(createRadiostationDto) {
        return this.catsService.createRS(createRadiostationDto);
    }
    async findAll() {
...
], CatsController.prototype, "createRS", null);
__decorate([
    common_1.Get(),
    openapi.ApiResponse({ status: 200, type: [require("./schemas/cat.schema").Cat] }),
    __metadata("design:type", Function),
